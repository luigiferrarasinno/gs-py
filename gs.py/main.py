...
#craindo fução para adicionar pacientes
def pacientes():
    #fazendo validação
     usuario=input("digite o login:")
     senha=input("digite a sua senha:")
...
#criando a funçao para criar usuario
...
#criando a função para ver atividades do paciente
...
#criando função para addiionar medicos
def criar_medico():
#criando validação
     usuario=input("digite o login:")
     senha=input("digite a sua senha:")
...
#criaçaõ do menu que engloba todas as funções
...
while opcao != 0:
    match opcao:
        ...
        case 7:
            if usuariologado:
                #validaçaõ do usuario e do paciente
                 nome = input("Digite o nome do paciente: ")
                 codigo = input("Digite o código do paciente: ")
        ...
        case 9:
            #validação do master
             usuario=input("digite o login:")
             senha=input("digite a sua senha:")
             #criando função para ver os medicos
             if  usuario=="python" and senha=="fiap":
                    print(f'master logado')
